...
describe "titlereceipts/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit titlereceipt form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => titlereceipts_path(@titlereceipt), :method => "post" do
